            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnCheckUid"><img src="/Farmstory2/img/chk_id.gif" alt="중복확인"/></button>
                ...
                <tr>
                    <td>비밀번호 확인</td>
                    <td><input type="password" name="pass2" class="checkPass" placeholder="비밀번호 입력 확인"/></td>
                </tr>
            </table>
            ...
            <table border="1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" id="btnCheckNick"><img src="/Farmstory2/img/chk_id.gif" alt="중복확인"/></button>
                ...
                <tr>
                    <td>휴대폰</td>
                    <td>
                    	<input type="text" name="hp" class="checkHp" placeholder="휴대폰 입력"/>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btnFindZip"><img src="/Farmstory2/img/chk_post.gif" alt="우편번호찾기"/></button>
