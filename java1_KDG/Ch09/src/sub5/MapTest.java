...
public class MapTest {
		...
		public static void main(String[] args) {
			...
			m2.put(102, new Apple("영국", 2000));
			m2.put(103, new Apple("호주", 1000));
			
			Map<Integer, Apple> m3 = new HashMap<>();
			m3.put(101, new Apple("태국", 3000));
			m3.put(102, new Apple("대만", 2000));
			m3.put(103, new Apple("홍콩", 1000));
